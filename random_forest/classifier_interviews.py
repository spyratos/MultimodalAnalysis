...
def main():
    ...
    aT.featureAndTrain(['/home/kostis/Desktop/MultimodalAnalysis/negative','/home/kostis/Desktop/MultimodalAnalysis/positive'], mtwin, mtmove, stwin, stmove, "randomforest", "randomforest_inter")
