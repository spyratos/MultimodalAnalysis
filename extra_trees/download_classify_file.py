...
def main():
   ...
   # for i in range(len(df)):
    ...
    predicted=aA.classifyFolderWrapper("/home/kostis/Desktop/MultimodalAnalysis1/toclassify/","extratrees","/home/kostis/Desktop/MultimodalAnalysis/extra_trees/extratrees_inter",outputMode=True)
