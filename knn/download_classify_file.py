...
def main():
   ...
   # for i in range(len(df)):
    ...
    predicted=aA.classifyFolderWrapper("/home/kostis/Desktop/MultimodalAnalysis1/toclassify/","knn","/home/kostis/Desktop/MultimodalAnalysis/knn/knn_inter",outputMode=True)
