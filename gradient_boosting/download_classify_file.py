...
def main():
   ...
   # for i in range(len(df)):
    ...
    predicted=aA.classifyFolderWrapper("/home/kostis/Desktop/MultimodalAnalysis1/toclassify/","extratrees","/home/kostis/Desktop/MultimodalAnalysis/gradient_boosting/gradientboosting_inter",outputMode=True)
